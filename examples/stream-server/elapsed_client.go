...
import (
	...
	"github.com/istforks/go-swagger/examples/stream-server/client"
	"github.com/istforks/go-swagger/examples/stream-server/client/operations"
	"github.com/istforks/go-swagger/examples/stream-server/models"
)
