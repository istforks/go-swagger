...
import (
	...
	"github.com/istforks/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/istforks/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
