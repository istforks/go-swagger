...
import (
	...
	"github.com/istforks/go-swagger/examples/tutorials/todo-list/server-complete/models"
	"github.com/istforks/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations"
	"github.com/istforks/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations/todos"
)
