...
import (
	...
	"github.com/istforks/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/istforks/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
