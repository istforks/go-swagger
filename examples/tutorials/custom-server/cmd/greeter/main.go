...
import (
	...
	"github.com/istforks/go-swagger/examples/tutorials/custom-server/gen/restapi"
	"github.com/istforks/go-swagger/examples/tutorials/custom-server/gen/restapi/operations"
)
