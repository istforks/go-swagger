...
import (
	...
	"github.com/istforks/go-swagger/examples/composed-auth/restapi/operations"

	auth "github.com/istforks/go-swagger/examples/composed-auth/auth"
	models "github.com/istforks/go-swagger/examples/composed-auth/models"
)
