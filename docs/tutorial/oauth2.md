...
![Google api screenshot](https://github.com/istforks/go-swagger/blob/master/examples/oauth2/img/google-api.png)
...
[example_code]: https://github.com/istforks/go-swagger/blob/master/examples/oauth2/
