...
func TestSchemaBuilder(t *testing.T) {
	...
	pn := "github.com/istforks/go-swagger/fixtures/goparsing/classification/models"
	assert.True(t, ok)
...
func getClassificationModel(sctx *scanCtx, nm string) *entityDecl {
	decl, ok := sctx.FindDecl("github.com/istforks/go-swagger/fixtures/goparsing/classification/models", nm)
	if !ok {
		return nil
	}
	return decl
